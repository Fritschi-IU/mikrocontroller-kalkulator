...
-Operatorrengfolge bei mehreren Rechenschritten
...
3. Projekt mit "Lokaler Windows-Debbuger" starten
...
Die Mikrocontroller-Anwendung wird mit avr-gcc kompiliert und mit avrdude auf den Arduino Uno übertragen.
